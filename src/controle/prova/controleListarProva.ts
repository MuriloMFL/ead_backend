...
class ControleListarProva {
    async handle(req:Request, res: Response){
        const {id_prova, id_sistema, nome_prova, id_modulo, id_submodulo, status, id_usuario} = req.query;
        
        console.log(id_prova, id_sistema, nome_prova, id_modulo, id_submodulo, status, id_usuario)
